...
datatype = st.radio(label="Choose detection data type: ", options=["1 detector", "Coincidence with 2 detectors", "Coincidence with 3 detectors"])

import homepages
if datatype == "1 detector":
    homepages.one_home()
elif datatype == "Coincidence with 2 detectors": 
    homepages.two_home()
else: 
